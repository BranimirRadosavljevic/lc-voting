                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div 
                        ...
                        <button @click="isOpen=!isOpen">
                            ...
                            <div class="absolute rounded-full bg-red text-white text-xxs w-6 h-6 flex justify-center items-center 
                                     border-2 -top-1 -right-1">
                                5
                            </div>
                        </button>
                        <ul x-cloak x-show.transition.origin.top="isOpen" @click.away="isOpen=false"
                            @keydown.escape.window="isOpen=false"
                            class="absolute w-76 md:w-96 text-left bg-white shadow-dialog rounded-xl z-10 max-h-128 overflow-y-auto -right-28 md:-right-12"
                            {{-- style="right: -46px" --}}
                            >
                            <li>
                                <a href="#" @click.prevent="
                                    ...
                                    <div class="ml-4">
                                        <div class="line-clamp-6">
                                            <span class="font-semibold">Bane</span> commented on
                                            <span class="font-semibold">This is my idea</span>:
                                            <span>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit,
                                                doloremque. Corporis, expedita vero, ducimus non fugit ipsa, officia
                                                inventore harum perspiciatis repudiandae ea quas quae! Quasi ullam vitae
                                                consectetur mollitia cumque cupiditate totam odio eveniet velit quaerat
                                                est aperiam ratione nemo veritatis rem officia itaque, error natus eum
                                                voluptatum quae."</span>
                                        </div>
        ...
        <div class="w-70 mx-auto md:mx-0 md:mr-5">
            <div class="bg-white md:sticky md:top-8 border-2 border-blue rounded-xl mt-16" style="
                ...
                <div class="my-6 text-center">
                    <a href="{{ route('login') }}" class="inline-block justify-center w-1/2 h-11 text-xs bg-blue text-white font-semibold rounded-xl 
