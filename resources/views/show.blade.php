        ...
        <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    ...
                    Ullam nostrum blanditiis, eveniet error voluptate similique qui numquam asperiores consectetur saepe
                    quaerat sunt assumenda. Eius aspernatur quidem, beatae similique illo adipisci!
                </div>
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    <div x-data={isOpen:false} class="flex items-center space-x-2 mt-4 md:mt-0">
                        ...
                        <button @click="isOpen=!isOpen"
                            ...
                            <ul x-cloak x-show.transition.origin.top.left="isOpen" @click.away="isOpen=false"
                                ...
                                class="absolute w-44 text-left font-semibold bg-white shadow-dialog rounded-xl z-10 py-3                                md:ml-8
                    ...
                    <div class="flex items-center md:hidden mt-4 md:mt-0">
                        ...
                        <button class="w-20 bg-gray-200 border border-gray-200 font-bold 
                            text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3 -mx-5">Vote</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
            <div 
                ...
                <button 
                    @click="isOpen=!isOpen"
                    type="button" class="flex items-center justify-center w-32 h-11 text-sm bg-blue text-white font-semibold rounded-xl
                ...
                <div 
                    ...
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            <button type="button" class="flex items-center justify-center w-full md:w-1/2 h-11 text-sm bg-blue text-white font-semibold rounded-xl
                                    border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 ">
                                Post Comment
                            </button>
                            <button type="button" class="flex items-center justify-center w-full md:w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl 
                ...
                <div x-cloak x-show.transition.origin.top.left="isOpen" @click.away="isOpen=false"
                    ...
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="bg-gray-200 text-gray-700 border-none" type="radio" checked=""
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="bg-gray-200 text-purple border-none" type="radio" name="radio-direct"
                                        value="2">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="bg-gray-200 text-yellow border-none" type="radio" name="radio-direct"
                                        value="3">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="bg-gray-200 text-green border-none" type="radio" name="radio-direct"
                                        value="3">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input class="bg-gray-200 text-red border-none" type="radio" name="radio-direct"
                                        value="3">
                        ...
                        <div class="flex items-center space-x-3">
                            <button type="button" class="flex items-center justify-center w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl 
                            ...
                            <button type="button" class="flex items-center justify-center w-1/2 h-11 text-sm bg-blue text-white font-semibold rounded-xl
                                    border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 ">
                                Update
                            </button>
                        </div>
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            <button type="button"
                class="w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl uppercase
                                border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3 ">
                <span>Vote</span>
            </button>
        </div>
        ...
        <div class="is-admin comment-container relative bg-white rounded-xl flex mt-4">
            <div class="flex flex-1 px-4 py-6">
                <div class="flex-none">
                    ...
                    <div class="text-center text-blue font-bold text-xxs uppercase mt-1">Admin</div>
                </div>
                <div class="w-full mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                            <div class="font-bold text-blue">Marijana</div>
                            <div>&bull;</div>
                            <div>10 hours ago</div>
                        </div>
