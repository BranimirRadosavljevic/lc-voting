<div class="idea-and-buttons-container">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    <div class="flex items-center md:hidden mt-4 md:mt-0">
                        ...
                        <button wire:click.prevent="vote"
                            class="w-20 bg-blue border border-blue text-white font-bold
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if ($hasVoted)
            <button wire:click.prevent="vote" type="button" class="w-32 h-11 text-xs bg-blue font-semibold text-white rounded-xl uppercase
                        border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 ">
                <span>Voted</span>
            </button>

            @else
            <button wire:click.prevent="vote" type="button" class="w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl uppercase
