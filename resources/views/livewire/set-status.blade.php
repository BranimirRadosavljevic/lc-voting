    ...
    <div x-cloak x-show.transition.origin.top.left="isOpen" @click.away="isOpen=false"
        ...
        <form wire:submit.prevent="setStatus" action="#" class="space-y-4 px-4 py-6">
            <div class="space-y-2">
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" class="bg-gray-200 text-gray-700 border-none" type="radio" checked=""
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" class="bg-gray-200 text-purple border-none" type="radio"
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" class="bg-gray-200 text-yellow border-none" type="radio"
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" class="bg-gray-200 text-green border-none" type="radio"
                ...
                <div>
                    <label class="inline-flex items-center">
                        <input wire:model="status" class="bg-gray-200 text-red border-none" type="radio"
            ...
            <div class="flex items-center space-x-3">
                <button type="button"
                    class="flex items-center justify-center w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl
